(function () {
  ...
  const translations = {
    es: {
      ...
      "Yes, there is a refundable application fee of $85, which is paid through Chime after your application is submitted.": "Sí, hay una tarifa de solicitud reembolsable de $85, que se paga a través de Chime después de enviar su solicitud.",
      ...
      "Please note that a refundable $85 application fee is required before the approval process can begin.": "Tenga en cuenta que se requiere una tarifa de solicitud reembolsable de $85 antes de que pueda comenzar el proceso de aprobación.",
    ...
    zh: {
      ...
      "Yes, there is a refundable application fee of $85, which is paid through Chime after your application is submitted.": "是的，有一笔 85 美元的可退还申请费，需在提交申请后通过 Chime 支付。",
    ...
    fr: {
      ...
      "Yes, there is a refundable application fee of $85, which is paid through Chime after your application is submitted.": "Oui, il y a des frais de demande remboursables de 85 $, payés via Chime après l’envoi de votre demande.",
    ...
    pt: {
      ...
      "Yes, there is a refundable application fee of $85, which is paid through Chime after your application is submitted.": "Sim, há uma taxa de solicitação reembolsável de US$ 85, paga pelo Chime após o envio da solicitação.",
    ...
    ar: {
      ...
      "Yes, there is a refundable application fee of $85, which is paid through Chime after your application is submitted.": "نعم، توجد رسوم طلب قابلة للاسترداد بقيمة 85 دولارًا، وتُدفع عبر Chime بعد إرسال طلبك.",
  ...
  const postFlowTranslations = {
    es: {
      ...
      "Application ID:": "ID de solicitud:",
      "Refundable application fee": "Tarifa de solicitud reembolsable",
      "I understand that a refundable $85 application fee is required to proceed with the application process.": "Entiendo que se requiere una tarifa de solicitud reembolsable de $85 para continuar con el proceso de solicitud.",
      ...
      "A refundable $85 application fee is required before your application can move into the formal review and approval process.": "Se requiere una tarifa de solicitud reembolsable de $85 antes de que su solicitud pueda pasar al proceso formal de revisión y aprobación.",
      "Payment instructions": "Instrucciones de pago",
    ...
    fr: {
      ...
      "Refundable application fee": "Frais de demande remboursables",
      "I understand that a refundable $85 application fee is required to proceed with the application process.": "Je comprends que des frais de demande remboursables de 85 $ sont requis pour poursuivre le processus de demande.",
      ...
      "A refundable $85 application fee is required before your application can move into the formal review and approval process.": "Des frais de demande remboursables de 85 $ sont requis avant que votre dossier puisse entrer dans le processus formel d’examen et d’approbation.",
      "Payment instructions": "Instructions de paiement",
    ...
    zh: {
      ...
      "Application ID:": "申请编号：",
      "Refundable application fee": "可退还申请费",
      "I understand that a refundable $85 application fee is required to proceed with the application process.": "我理解需要支付 85 美元可退还申请费才能继续申请流程。",
      ...
      "Fee overview": "费用概览",
      "A refundable $85 application fee is required before your application can move into the formal review and approval process.": "在进入正式审核和批准流程之前，需要支付可退还的 85 美元申请费。",
      "Payment instructions": "付款说明",
    ...
    ar: {
      ...
      "Refundable application fee": "رسوم طلب قابلة للاسترداد",
      "I understand that a refundable $85 application fee is required to proceed with the application process.": "أفهم أن رسوم طلب قابلة للاسترداد بقيمة 85 دولارًا مطلوبة للمتابعة في عملية التقديم.",
      ...
      "A refundable $85 application fee is required before your application can move into the formal review and approval process.": "مطلوب رسوم طلب قابلة للاسترداد بقيمة 85 دولارًا قبل أن ينتقل طلبك إلى عملية المراجعة والموافقة الرسمية.",
      "Payment instructions": "تعليمات الدفع",
  ...
  const workflowTranslations = {
    ...
    zh: {
      ...
      "Please note that a refundable $85 application fee is required before the approval process can begin.": "请注意，在审批流程开始之前，需要支付可退还的 85 美元申请费。",
    ...
    fr: {
      ...
      "Please note that a refundable $85 application fee is required before the approval process can begin.": "Veuillez noter qu’une demande de frais de dossier remboursables de 85 $ est requise avant que le processus d’approbation puisse commencer.",
    ...
    ar: {
      ...
      "Please note that a refundable $85 application fee is required before the approval process can begin.": "يرجى ملاحظة أن رسوم طلب قابلة للاسترداد بقيمة 85 دولارًا أمريكيًا مطلوبة قبل أن تبدأ عملية الموافقة.",
  ...
  Object.assign(aliases, {
    ...
    "Una tarifa de solicitud reembolsable es un pago que se le devolverá si su solicitud no es aprobada o si decide no continuar después de la visita.": "A refundable application fee is a payment that will be returned to you if your application is not approved or if you decide not to move forward after the tour.",
    "Sí, hay una tarifa de solicitud reembolsable de $85, que se paga a través de Chime después de enviar su solicitud.": "Yes, there is a refundable application fee of $85, which is paid through Chime after your application is submitted.",
    ...
    "Tenga en cuenta que se requiere una tarifa de solicitud reembolsable de $85 antes de que pueda comenzar el proceso de aprobación.": "Please note that a refundable $85 application fee is required before the approval process can begin.",
  ...
  const FORMSPREE_APPLICATION_ENDPOINT = "https://formspree.io/f/mdeonjen";
  const APPLICATION_NOTIFICATION_EMAIL = "privatepropertyg@gmail.com";
